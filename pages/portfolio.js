...
import C, * as _rest from '../pages_/portfolio'
import ns0 from '../locales/az/common.json'
import ns1 from '../locales/az/footer.json'
import ns2 from '../locales/az/header.json'
import ns3 from '../locales/az/portfolio.json'

const namespaces = { 'common': ns0, 'footer': ns1, 'header': ns2, 'portfolio': ns3 }
