...
import C, * as _rest from '../pages_/about-company'
import ns0 from '../locales/az/common.json'
import ns1 from '../locales/az/footer.json'
import ns2 from '../locales/az/header.json'
import ns3 from '../locales/az/about.json'

const namespaces = { 'common': ns0, 'footer': ns1, 'header': ns2, 'about': ns3 }
...
export * from '../pages_/about-company'
