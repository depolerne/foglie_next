...
module.exports = __webpack_require__("mzq2");
...
// CONCATENATED MODULE: ./components/about/company.tsx
...
`;
const Image = styled_default.a.img`
  object-fit: cover;
  width: 100%;
  height: 100%;
`;
...
`;
const Description = styled_default.a.div`
  max-width: 640px;
...
`;
const Line = styled_default.a.div`
  position: absolute;
...
`;
const Block = styled_default.a.div`
  width: 64px;
  height: 64px;
...
`;
const BackgroundImage = styled_default.a.picture`
  position: absolute;
  z-index: -1;
  top: 120px;
  left: -64px;
...
const Company = ({
  ...
  return __jsx(Container, null, __jsx(ImageWrapper, null, __jsx(Image, {
    src: about.image.url,
    alt: "About company image"
  })), __jsx(Content, null, __jsx(BackgroundImage, null, __jsx("source", {
    srcSet: "/static/about-company-bg.webp",
    type: "image/webp"
  }), __jsx("source", {
    srcSet: "/static/about-company-bg.png",
    type: "image/png"
  }), __jsx("img", {
    src: "/static/about-company-bg.png",
    alt: "Background image"
  })), __jsx(PageTitle["a" /* PageTitle */], {
    title: about.title,
  ...
  }), __jsx(Block, null)), __jsx(Line, null));
};
...
// CONCATENATED MODULE: ./pages_/about-company.tsx

var about_company_jsx = external_react_default.a.createElement;
...
const AboutCompany = ({
  ...
  const branch = external_swr_default()(company_service["a" /* AboutCompanyService */].getOneQuery(lang), q => company_service["a" /* AboutCompanyService */].getOne(q, lang), {
    initialData
  });
  return about_company_jsx(layout["a" /* default */], {
    description: "Informatin about our company",
    title: t("about:title")
  }, about_company_jsx(Async["a" /* Async */], {
    branch: branch,
    renderData: about => about_company_jsx(Company, {
      about: about
    })
  }));
};
...
async function getStaticProps({
  ...
  const initialData = await company_service["a" /* AboutCompanyService */].getOne(company_service["a" /* AboutCompanyService */].getOneQuery(lang), lang);
  return {
    props: {
      initialData
    }
...
/* harmony default export */ var about_company = __webpack_exports__["a"] = (AboutCompany);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("cDcd");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _pages_about_company__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("lzeW");
...
/* harmony import */ var _locales_ru_about_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("JzCH");
var _locales_ru_about_json__WEBPACK_IMPORTED_MODULE_6___namespace = /*#__PURE__*/__webpack_require__.t("JzCH", 1);
var __jsx = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement;
...
const namespaces = {
  ...
  'about': _locales_ru_about_json__WEBPACK_IMPORTED_MODULE_6__
};
function Page(p) {
  return __jsx(next_translate_I18nProvider__WEBPACK_IMPORTED_MODULE_0___default.a, {
    ...
    isStaticMode: true
  }, __jsx(_pages_about_company__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], p));
}
Page = Object.assign(Page, _objectSpread({}, _pages_about_company__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"]));

if (_pages_about_company__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].getInitialProps) {
  Page.getInitialProps = ctx => _pages_about_company__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].getInitialProps(_objectSpread({}, ctx, {
    lang: 'ru'
  }));
}

const getStaticProps = ctx => _pages_about_company__WEBPACK_IMPORTED_MODULE_2__[/* getStaticProps */ "b"](_objectSpread({}, ctx, {
  lang: 'ru'
}));
