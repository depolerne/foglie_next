...
module.exports = __webpack_require__("7j4c");
...
/* harmony import */ var _locales_ru_pricing_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("XcMC");
var _locales_ru_pricing_json__WEBPACK_IMPORTED_MODULE_6___namespace = /*#__PURE__*/__webpack_require__.t("XcMC", 1);
...
const namespaces = {
  ...
  'pricing': _locales_ru_pricing_json__WEBPACK_IMPORTED_MODULE_6__
};
function Page(p) {
...
module.exports = JSON.parse("{\"title\":\"Цены\",\"subtitle\":\"Как мы работаем\",\"text\":\"Получить расценку\",\"description\":\"Понимание интересов и потребностей каждого клиента лежит в основе нашей бизнес-модели. Таким образом, наши цены варьируются в зависимости от услуг, которые мы предоставляем каждому отдельному клиенту. Если вы заинтересованы в наших услугах, свяжитесь с нами для получения абсолютно бесплатной консультации, и мы составим для вас индивидуальное предложение.\"}");
