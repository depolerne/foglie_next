...
/* harmony import */ var _pages_pricing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("Kl4o");
...
/* harmony import */ var _locales_az_pricing_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("GmEj");
var _locales_az_pricing_json__WEBPACK_IMPORTED_MODULE_6___namespace = /*#__PURE__*/__webpack_require__.t("GmEj", 1);
...
const namespaces = {
  ...
  'pricing': _locales_az_pricing_json__WEBPACK_IMPORTED_MODULE_6__
};
function Page(p) {
  return __jsx(next_translate_I18nProvider__WEBPACK_IMPORTED_MODULE_0___default.a, {
    ...
    isStaticMode: true
  }, __jsx(_pages_pricing__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], p));
}
Page = Object.assign(Page, _objectSpread({}, _pages_pricing__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"]));

if (_pages_pricing__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].getInitialProps) {
  Page.getInitialProps = ctx => _pages_pricing__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].getInitialProps(_objectSpread({}, ctx, {
    lang: 'az'
  }));
}

const getStaticProps = ctx => _pages_pricing__WEBPACK_IMPORTED_MODULE_2__[/* getStaticProps */ "b"](_objectSpread({}, ctx, {
  lang: 'az'
}));
...
module.exports = __webpack_require__("0W4r");
...
module.exports = JSON.parse("{\"title\":\"Qiymətlər\",\"subtitle\":\"Biz necə işləyirik\",\"text\":\"Qiymət təklifi üçün\",\"description\":\"Hər bir müştərinin maraq və ehtiyaclarını başa düşmək və qiymətləndirmək bizim iş modelimizin əsasını təşkil edir. Beləliklə, qiymətlərimiz hər bir müştəriyə göstərdiyimiz xidmətlərə görə dəyişir. Xidmətlərimizlə maraqlanırsınızsa, tamamilə pulsuz bir məsləhət üçün bizimlə əlaqə saxlayın və biz sizin üçün özəl bir təkliflə geri dönəcəyik.\"}");
...
// EXTERNAL MODULE: external "next-translate/Router"
var Router_ = __webpack_require__("e4xP");
...
// CONCATENATED MODULE: ./components/pricing/price-block.tsx

var __jsx = external_react_default.a.createElement;


const style = {
  title: Object(core_["css"])({
    marginTop: 32,
    textTransform: "uppercase"
  }),
  description: Object(core_["css"])({
    marginTop: 16
  })
};
const card = core_["css"]`
...
const PriceBlock = ({
  ...
  let image = "";
  if (imageIndex === 0) image = "/static/pricing-talk.svg";else if (imageIndex === 1) image = "/static/pricing-document.svg";else if (imageIndex === 2) image = "/static/pricing-checked-document.svg";
  return __jsx("div", {
    css: card
  }, __jsx("img", {
    src: image,
...
/* harmony default export */ var price_block = (PriceBlock);
// CONCATENATED MODULE: ./components/pricing/price-list.tsx

var price_list_jsx = external_react_default.a.createElement;



const grid = core_["css"]`
  display: grid;
...
const PriceList = ({
  ...
  return price_list_jsx("div", {
    css: grid
  }, pricings.map((pricing, index) => price_list_jsx(price_block, {
    imageIndex: index,
    key: pricing.id,
    title: pricing.title
  })));
...
// CONCATENATED MODULE: ./services/pricingService.ts
...
// CONCATENATED MODULE: ./pages_/pricing.tsx
...
const StyledText = styled_default()(Typography["a" /* Typography */])`
  ...
  margin-bottom: 64px;
`;
const StyledContainer = styled_default()(container["a" /* Container */])`
  margin-bottom: 104px;
`;
...
const Pricing = ({
  ...
  const branch = external_swr_default()(PricingService.getManyQuery(lang), query => PricingService.getMany(query, lang), {
    initialData,
    refreshInterval: 0
  });
  return pricing_jsx(layout["a" /* default */], {
    description: "Our pricing",
    title: t("pricing:title")
  }, pricing_jsx(external_react_default.a.Fragment, null, pricing_jsx(BackgroundImage["a" /* BackgroundImage */], null, pricing_jsx("source", {
    srcSet: "/static/pricing-bg.webp",
    type: "image/webp"
  }), pricing_jsx("source", {
    srcSet: "/static/pricing-bg.png",
    type: "image/png"
  }), pricing_jsx("img", {
    src: "/static/pricing-bg.png",
    alt: "Background image"
  })), pricing_jsx(StyledContainer, null, pricing_jsx(PageTitle["a" /* PageTitle */], {
    subtitle: t("pricing:subtitle"),
    title: t("pricing:title"),
    css: core_["css"]`
              margin-bottom: 64px;
            `
  }), pricing_jsx(Async["a" /* Async */], {
    branch: branch,
    minHeight: "188px",
    renderData: pricings => pricing_jsx(PriceList, {
      pricings: pricings
    })
  }), pricing_jsx(StyledText, {
    variant: "body1",
    text: t("pricing:description"),
    css: core_["css"]`
              margin-top: 64px;
            `
  }), pricing_jsx(LoadMore["a" /* LoadMore */], {
    onClick: () => Router_default.a.pushI18n("/contact"),
...
/* harmony default export */ var pages_pricing = __webpack_exports__["a"] = (Pricing);
...
module.exports = require("next-translate/Router");
